<? include('config.php'); $back_link='<a href="javascript: history.back(-1);">'; ?><!doctype html>
<html lang="en">
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<title><?= strip_tags($thanks1) ?></title>
...
<div class="page-header">
  <h1 class="red"><strong><?= $thanks1 ?></strong> </h1>
  </div></div>
 
 
  
    <h4 class="text-center"><?= $thanks2 ?></h4>
      <div class="success">
                <ul class="list_info">
   ...
   <p class="text-center"><?= str_ireplace("%back_link%", $back_link, $thanks3); ?></a></p>
